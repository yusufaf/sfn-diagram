...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="examples/outputs/parallel-dark.svg">
  <img src="examples/outputs/parallel-light.svg" alt="Example diagram of a Parallel state Step Functions workflow generated by sfn-diagram" width="410">
</picture>
