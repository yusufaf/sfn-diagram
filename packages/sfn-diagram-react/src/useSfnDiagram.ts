...
export interface UseSfnDiagramParams
     ...
     * JSON string. Cannot be combined with `history` or `format="html"` - core's
     * `generateHtml` accepts both overlays since sfn-diagram 1.8, but this hook does
     * not wire them up yet.
     *
