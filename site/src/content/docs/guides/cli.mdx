...
They support every format except `png`, which needs the headless browser only the
Docker image bundles. See [Use from Python, Go, Java, and other languages](/guides/other-languages/).
