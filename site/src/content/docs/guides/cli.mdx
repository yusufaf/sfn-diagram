...
They support every format except `png`, which needs a headless browser: use the
Docker image above or the npm package with `node-html-to-image` installed. See
