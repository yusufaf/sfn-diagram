...
wheel until you engage with it — click or tap the diagram, or move keyboard focus into
it — and gives the wheel back once you click elsewhere on the page. Ctrl+wheel (a
trackpad pinch) zooms the diagram at any time.
